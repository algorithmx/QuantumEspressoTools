...
function ph_qpoint_section(res::Vector{String})
...
function ph_qpoints(res::Vector{String})
    _f_rstr = r"-?\d+\.\d*((e|E)-?\d+)?"
...
function ph_qpoint_coords(res_section::Vector{String})
    _f_rstr = r"-?\d+\.\d*"
    _3f_rstr = _f_rstr * r"\s+" * _f_rstr * r"\s+" * _f_rstr
...
function ph_qpoint_freqs(res_section::Vector{String})
...
ph_frequency(result_lines::Vector{String}) = Dict(  ph_qpoint_coords(sect)=>ph_qpoint_freqs(sect)
                                                    for sect in ph_qpoint_section(result_lines)  )

ph_frequency_cm_1(result_lines::Vector{String}) = Dict(  ph_qpoint_coords(sect)=>ph_qpoint_freqs(sect)[2]
                                                         for sect in ph_qpoint_section(result_lines)  )

ph_frequency_THz(result_lines::Vector{String}) = Dict(  ph_qpoint_coords(sect)=>ph_qpoint_freqs(sect)[1]
                                                        for sect in ph_qpoint_section(result_lines)  )

ph_max_frequency_THz(result_lines::Vector{String})  = maximum(vcat(first.(values(ph_frequency(result_lines)))...))
ph_max_frequency_cm_1(result_lines::Vector{String}) = maximum(vcat(last.(values(ph_frequency(result_lines)))...))
ph_min_frequency_THz(result_lines::Vector{String})  = minimum(vcat(first.(values(ph_frequency(result_lines)))...))
ph_min_frequency_cm_1(result_lines::Vector{String}) = minimum(vcat(last.(values(ph_frequency(result_lines)))...))
